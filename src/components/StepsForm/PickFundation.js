      ...
      <div className="form_wrapper">
        ...
        <div className="form_body">
          ...
          <div onChange={handleHelpGroups}>
            ...
            <label>
              <input type="checkbox" name="toWho" value="dzieciom" />
              dzieciom
            </label>
            <label>
              <input type="checkbox" name="toWho" value="samotnym matkom" />
              samotnym matkom
            </label>
            <label>
              <input type="checkbox" name="toWho" value="bezdomnym" />
              bezdomnym
            </label>
            <label>
              <input type="checkbox" name="toWho" value="niepełnosprawnym" />
              niepełnosprawnym
            </label>
            <label>
              <input type="checkbox" name="toWho" value="osobom starszym" />
              osobom starszym
            </label>
            <label>
              <h5>Wpisz nazwę konkretnej organizacji(opconalne)</h5>
              <input onChange={onChangeLocSpec} type="text" value={localizationSpecific} />
            </label>
          </div>
        </div>
      </div>
